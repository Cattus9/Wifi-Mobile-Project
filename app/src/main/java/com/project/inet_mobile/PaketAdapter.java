...
public class PaketAdapter extends RecyclerView.Adapter<PaketAdapter.PaketViewHolder> {
    ...
    private String buildDetailText(Paket paket) {
        if (paket == null) {
            return "";
        }

        String speed = paket.getSpeed();
        String description = paket.getDescription();

        boolean hasSpeed = speed != null && !speed.isEmpty();
        boolean hasDescription = description != null && !description.isEmpty();

        if (hasSpeed && hasDescription) {
    ...
    public class PaketViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Paket paket, int position) {
            ...
            String detailText = buildDetailText(paket);
