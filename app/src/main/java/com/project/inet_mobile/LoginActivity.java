...
/**
 * LoginActivity (versi rapi)
 * - Tanpa AsyncTask (pakai Thread + Handler main looper)
 * - SharedPreferences untuk sesi (isLoggedIn, id, name, email, accessToken)
 * - Delay UX 2 detik konsisten (sukses/gagal)
 * - Tidak fallback ke anon key untuk endpoint privat (lebih aman bila RLS aktif)
 */
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Skip autologin during debugging - always show login screen
        // Autologin sederhana: cek flag & token ada (tanpa verifikasi expiry)
